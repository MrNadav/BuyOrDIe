...
export const Header = () => {
    ...
    <header>
        ...
        <nav className='pt-3 pr-5 text-lg'>
            <ul className='flex justify-start max-w-screen-xl p-5 ml-5 text-zinc-500 gap-x-12 font-bold'>
            <Link to='/'><img src="src/assets/images/logo.webp" className='h-6' /></Link>
                <li>
